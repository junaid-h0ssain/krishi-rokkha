...
const translations = {
    en: {
        ...
        "impact_text": "Since our pilot launch, KrishiRokkha has helped over 500 farmers across 3 districts reduce post-harvest losses by an average of 35%. Our users report better decision-making, increased confidence, and significant savings.",
        "sdg_title": "Aligned with UN SDGs",
        "sdg_text": "KrishiRokkha directly contributes to SDG 2 (Zero Hunger), SDG 12 (Responsible Consumption), and SDG 13 (Climate Action) by reducing food waste and empowering farmers with climate-smart agriculture tools.",

        // Farmer Stories Page
        "stories_hero": "Real Stories from Real Farmers",
        "stories_intro": "Hear directly from the farmers who are using KrishiRokkha to protect their harvests and improve their livelihoods.",
        "farmer_1_name": "Rafique, Barishal",
        "farmer_1_story": "Last year, sudden rains destroyed 40% of my rice. This year, KrishiRokkha warned me in advance—I covered my grains. 90% of my harvest was saved.",
        ...
        "farmer_6_story": "The offline feature is amazing! Even when I don't have internet, I can still access important advisories. KrishiRokkha truly understands our needs.",

        // Research Page
        "research_intro_title": "Research Behind KrishiRokkha",
    ...
    bn: {
        ...
        "mission_text": "কৃষিরক্ষা বাংলাদেশে খাদ্য ক্ষতির বিরুদ্ধে লড়াই করার জন্য একটি প্রযুক্তি-চালিত সমাধান। প্রতি বছর ৪.৫ মিলিয়ন মেট্রিক টনেরও বেশি খাদ্যশস্য খারাপ সংরক্ষণ, আবহাওয়ার ঝুঁকি এবং অব্যবস্থাপনার কারণে নষ্ট হয়। আমাদের প্ল্যাটফর্ম আবহাওয়ার পূর্বাভাস, ফসল পর্যবেক্ষণ এবং প্রাথমিক সতর্কতা ব্যবহার করে কৃষকদের তাদের ফসল রক্ষা করতে সাহায্য করে।",
        ...
        "offer_title": "কৃষিরক্ষা যা অফার করে",
        ...
        "impact_text": "আমাদের পাইলট চালু হওয়ার পর থেকে, কৃষিরক্ষা ৩টি জেলা জুড়ে ৫০০ জনেরও বেশি কৃষককে গড়ে ৩৫% ফসল-পরবর্তী ক্ষতি কমাতে সাহায্য করেছে। আমাদের ব্যবহারকারীরা ভাল সিদ্ধান্ত গ্রহণ, বর্ধিত আত্মবিশ্বাস এবং উল্লেখযোগ্য সঞ্চয়ের কথা জানান।",
        "sdg_title": "জাতিসংঘ এসডিজির সাথে সংযুক্ত",
        "sdg_text": "কৃষিরক্ষা সরাসরি এসডিজি ২ (শূন্য ক্ষুধা), এসডিজি ১২ (দায়িত্বশীল ভোগ), এবং এসডিজি ১৩ (জলবায়ু পদক্ষেপ) এ অবদান রাখে খাদ্য অপচয় কমিয়ে এবং কৃষকদের জলবায়ু-স্মার্ট কৃষি সরঞ্জাম দিয়ে ক্ষমতায়ন করে।",

        // Farmer Stories Page
        "stories_hero": "প্রকৃত কৃষকদের প্রকৃত গল্প",
        "stories_intro": "সরাসরি শুনুন সেই কৃষকদের কাছ থেকে যারা তাদের ফসল রক্ষা করতে এবং তাদের জীবিকা উন্নত করতে কৃষিরক্ষা ব্যবহার করছেন।",
        "farmer_1_name": "রফিক, বরিশাল",
        "farmer_1_story": "গত বছর আকস্মিক বৃষ্টিতে আমার ধানের ৪০% নষ্ট হয়ে গিয়েছিল। এ বছর কৃষি-রক্ষার পূর্বাভাস আগে থেকেই জানিয়ে দিয়েছিল—তাই আমি শস্য ঢেকে রেখেছিলাম। আমার ৯০% ফসল রক্ষা পেয়েছে।আমি প্রথমবারের মতো নিয়ন্ত্রণে অনুভব করেছি—আবহাওয়ার ভয় ছিল না।",
        "farmer_2_name": "শামিমা, রাজশাহী",
        "farmer_2_story": "তাপমাত্রা বাড়লে ধানের রঙ বদলে যায়। অ্যাপের পরামর্শ মেনে আমি শস্যগুলো উঁচু স্থানে সংরক্ষণ করেছি। ক্ষতি উল্লেখযোগ্যভাবে কমেছে, আর দানা ছিটকে পড়াও অনেক কমেছে।",
        "farmer_3_name": "জালাল, ময়মনসিংহ",
        "farmer_3_story": "আগে কোন দিন ধান শুকানোর জন্য সবচেয়ে ভালো তা জানতাম না। এখন অ্যাপে দেখে সিদ্ধান্ত নেই। সমস্যাগুলো কমছে। ফসলের যত্ন নেওয়ার প্রতি আমার আত্মবিশ্বাসও বেড়ে গেছে।",
        "farmer_4_name": "আয়েশা, খুলনা",
        "farmer_4_story": "এআই স্ক্যানারটি পচা ফসলগুলো ছড়িয়ে পড়ার আগেই শনাক্ত করতে সাহায্য করেছে। আমি সেগুলো সাথে সাথে আলাদা করে ফেলেছি আর বাকি ফসল রক্ষা করতে পেরেছি। এই প্রযুক্তি সত্যিই পরিবর্তন আনছে!",
        "farmer_5_name": "করিম, সিলেট",
        "farmer_5_story": "বাংলা আবহাওয়া পূর্বাভাস বুঝতে আমার জন্য অনেক সহজ হয়ে গেছে। এখন আমি আরও ভালোভাবে সংরক্ষণের পরিকল্পনা করতে পারি এবং শেষ মুহূর্তের দুশ্চিন্তা এড়াতে পারি। এই মৌসুমে আমার আয় ২৫% বৃদ্ধি পেয়েছে।",
        "farmer_6_name": "ফাতিমা, রংপুর",
        "farmer_6_story": "অফলাইন ফিচারটি সত্যিই অসাধারণ! ইন্টারনেট না থাকলেও আমি গুরুত্বপূর্ণ পরামর্শগুলো সহজেই দেখতে পারি। কৃষি-রক্ষা সত্যিই আমাদের প্রয়োজনগুলো বুঝে।",

        // Research Page
        "research_intro_title": "কৃষিরক্ষা পেছনের গবেষণা",
